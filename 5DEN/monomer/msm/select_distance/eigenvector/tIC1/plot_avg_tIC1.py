...
t1=np.load('../../tica1.npy')[0:150000:1]
t2=np.load('../../tica1.npy')[150000:300000:1]
t3=np.load('../../tica1.npy')[300000:450000:1]
t4=np.load('../../tica1.npy')[450000:600000:1]
t5=np.load('../../tica1.npy')[600000::1]
#print t1[0], t1[1]
...
for k in range(len(avg)):
	plt.plot(x,avg[k],color=color[k])
#plt.errorbar(bincenters,y,yerr=err)
#plt.fillbetweenx(x,c,b)
	plt.fill_between(x,c[k],b[k],color=color[k],alpha=0.2)
